...
storageAccountKey='iqvNq084xXnBsaq7K+i19XJf2uLUkwwizKdT22RH+U5pdzSvP6K9Lg8f9qJvq7Z7OiXsI6o0wUeC+ASt4Z6kLA=='
spark.conf.set("fs.azure.account.key.adlsudalakehousedev.dfs.core.windows.net",storageAccountKey)

# COMMAND ----------

sourceCSVFilePath = 'abfss://labs@adlsudalakehousedev.dfs.core.windows.net/bronze/daily-pricing/csv'
targetJSONFilePath = 'abfss://labs@adlsudalakehousedev.dfs.core.windows.net/bronze/daily-pricing/json'
