...
# MAGIC %md
# MAGIC
# MAGIC Notebook Name : 04-Transform-DataLake-Geocoding
# MAGIC
# MAGIC GeoLocation JSON Source File Path : "abfss://bronze@datalakestorageaccountname.dfs.core.windows.net/geo-location/
# MAGIC "

# COMMAND ----------

geoLocationSourceLayerName = 'bronze'
geoLocationSourceStorageAccountName = 'adlsudalakehousedev'
...
# MAGIC %sql
# MAGIC select * from pricing_analytics.silver.geo_location_silver geolocation where geolocation.MARkETNAME = 'Guntur'

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM pricing_analytics.silver.daily_pricing_silver dailyPricing WHERE dailyPricing.MARkET_NAME = 'Guntur'
